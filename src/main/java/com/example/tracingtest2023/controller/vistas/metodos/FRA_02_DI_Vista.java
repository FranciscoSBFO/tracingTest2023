...
public class FRA_02_DI_Vista {
    ...
    @RequestMapping(value = "/registerFRADI/{id}")
    public String registerDimension(Model model, Principal principal, @PathVariable("id") Long id) {
        ...
        return "content/operacion/metodos/FRA_02_DI/formFRA_DI";
    }

    @RequestMapping("/listFRADI")
    public String listDimension(Model model, Principal principal) {
        ...
        return "content/operacion/metodos/FRA_02_DI/listFRA_DI";
    }
}
