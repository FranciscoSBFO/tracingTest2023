...
import com.example.tracingtest2023.service.operacion.metodos.FRA_EAUV_001_DATA_Service;
import com.example.tracingtest2023.service.operacion.metodos.FRA_EAUV_001_Service;
...
@Controller
@CrossOrigin
public class FRA_12_EAUV_Vista {
    ...
    public String registerFRAEAUV(Model model, Principal principal, @PathVariable("id") Long id) {
        ...
        return "content/operacion/metodos/FRA_12_EAUV/formFRA_EAUV";
    }
    ...
    public String agregarFRAEAUV(Model model, Principal principal, @PathVariable("id") Long id) {
        ...
        return "content/operacion/metodos/FRA_12_EAUV/formFRA_EAUV2";
    }
    ...
    public String terminarFRAEAUV(Model model, Principal principal, @PathVariable("id") Long id) {
        ...
        return "content/operacion/metodos/FRA_12_EAUV/formFRA_EAUV3";
    }
    ...
    public String listFRAEAUV(Model model, Principal principal) {
        ...
        return "content/operacion/metodos/FRA_12_EAUV/listFRA_EAUV";
    }
    ...
    public String verFRAEAUV(Model model, Principal principal, @PathVariable("id") Long id) {
        ...
        return "content/operacion/metodos/FRA_12_EAUV/verFRA_EAUV";
    }
}
