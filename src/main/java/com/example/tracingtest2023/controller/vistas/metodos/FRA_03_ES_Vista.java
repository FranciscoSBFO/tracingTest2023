...
public class FRA_03_ES_Vista {
    ...
    @RequestMapping(value = "/registerFRAES/{id}")
    public String registerEspesor(Model model, Principal principal, @PathVariable("id") Long id) {
        ...
        return "content/operacion/metodos/FRA_03_ES/formFRA_ES";
    }

    @RequestMapping("/listFRAES")
    public String listEspesor(Model model, Principal principal) {
        ...
        return "content/operacion/metodos/FRA_03_ES/listFRA_ES";
    }
}
