...
@Controller
@CrossOrigin
public class FRA_08_FTIR_Vista {
    ...
    @RequestMapping(value = "/registerFRAFTIR/{id}")
    public String registerEspectrometriaInfrarroja(Model model, Principal principal, @PathVariable("id") Long id) {
        ...
        return "content/operacion/metodos/FRA_08_FTIR/formFRA_FTIR";
    }

    @RequestMapping("/listFRAFTIR")
    public String listEspectrometriaInfrarroja(Model model, Principal principal) {
        ...
        return "content/operacion/metodos/FRA_08_FTIR/listFRA_FTIR";
    }
}
