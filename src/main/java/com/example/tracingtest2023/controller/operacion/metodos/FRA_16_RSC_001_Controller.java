...
import com.example.tracingtest2023.model.operacion.metodos.fra16rsc.datas.FRA_RSC_001_DATA;
import com.example.tracingtest2023.repository.operacion.metodos.fra16rsc.FRA_RSC_001_Repository;
import com.example.tracingtest2023.repository.operacion.metodos.fra16rsc.datas.FRA_RSC_001_DATA_Repository;
import com.example.tracingtest2023.service.formatos.metodos.FRA_16_RSC_Print;
...
public class FRA_16_RSC_001_Controller {
    ...
    public ResponseEntity<InputStreamResource> imprimir3() throws Exception {
        ...
        return lff_mie_met_xx_print.crearListaFolios("16-LFF-MIE-MET-RSC-001", 64L);
    }
}
