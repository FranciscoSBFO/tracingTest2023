package com.example.tracingtest2023.model.operacion.metodos.fra03es;
...
public class FRA_ES_001 {
    ...
    private String anchoProveta;
    private String numeroMediciones;
    ...
    public FRA_ES_001(Long idFRAES, String folioTecnica, String folioSolicitudServicioInterno, String idInternoMuestra, String fechaInicioAnalisis, String fechaFinalAnalisis, String temperatura, String humedadRelativa, String codigoMicrometro, String normaReferencia, String anchoProveta, String numeroMediciones, String promedioLargo, String promedioAncho, String observaciones, String realizo, String rubricaRealizo, String supervisor, String estatus, String cantidadModificaciones, Timestamp createdAt, Timestamp updatedAt, MetodoMuestra metodoMuestra) {
        this.idFRAES = idFRAES;
        ...
        this.anchoProveta = anchoProveta;
    ...
    public Long getIdFRAES() {
        return idFRAES;
    }

    public void setIdFRAES(Long idFRAES) {
        this.idFRAES = idFRAES;
    }
    ...
    public String getAnchoProveta() {
        return anchoProveta;
    }

    public void setAnchoProveta(String anchoProveta) {
        this.anchoProveta = anchoProveta;
    }

    public String getNumeroMediciones() {
        return numeroMediciones;
    }

    public void setNumeroMediciones(String numeroMediciones) {
        this.numeroMediciones = numeroMediciones;
    }
