...
public class FRA_12_EAUV_Print {
    ...
    public int fragmentoReporte (XWPFDocument doc, XWPFDocument plantilla, int contTabla, int contador, List<FRA_EAUV_001> lista) throws XmlException, IOException {
        ...
        table.removeRow(0);
        XWPFTable tableDocumment = plantilla.getTables().get(52);
        ...
        run2.setText("Resultados del envejecimiento acelerado por UV.");
        /***** FIN DE TÍTULO DE TABLA *****/

        /***** INICIO DE TABLA DE RESULTADOS *****/
        XWPFTable table_2 = doc.createTable();
        table_2.removeRow(0);
        XWPFTable tableDocumment_2 = plantilla.getTables().get(53);
        ...
        XWPFTable tableDocumment_4 = plantilla.getTables().get(54);
        try {
